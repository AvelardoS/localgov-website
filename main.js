...
// Form Submission
    document.getElementById("cntctfrm").addEventListener("submit", function (e) {
        e.preventDefault();
        alert("Thank you for reaching out! Your message has been received. We will get back to you as soon as possible.");
        this.reset();
    });
